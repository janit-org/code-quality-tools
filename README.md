...
```bash
composer require --dev janit-org/code-quality-tools
```
...
3. **Bundle defaults** (vendor/janit-org/code-quality-tools/config/quality-tools/)
...
```bash
cp vendor/janit-org/code-quality-tools/config/quality-tools/phpstan.neon phpstan.neon
...
cp vendor/janit-org/code-quality-tools/config/quality-tools/phpstan.neon config/quality-tools/
...
includes:
    - ../../vendor/janit-org/code-quality-tools/config/quality-tools/phpstan.neon
...
<ruleset name="MyProject">
    ...
    <rule ref="../../vendor/janit-org/code-quality-tools/config/quality-tools/phpcs.xml"/>
...
ls -la vendor/janit-org/code-quality-tools/config/quality-tools/
```
...
- **Issues:** https://github.com/janit-org/code-quality-tools/issues
- **Discussions:** https://github.com/janit-org/code-quality-tools/discussions
